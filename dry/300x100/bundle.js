    ...
    init: function init() {
      ...
      function display() {
        ...
        function animation() {
          ...
          tl.to('#txt-1,#logo', 1.5, {
            x: -300,
            ease: "expo.inOut"
          }, '+=1.5').to('#wipe-1', .3, {
            autoAlpha: 0
          }, '-=1').staggerFrom(['#txt-2', '#txt-3'], 1.5, {
            x: 300,
            ease: "expo.inOut"
          }, .05, '-=1.4').add("appear").from('#wipe-2', .1, {
            autoAlpha: 0
          }, "appear-=.7").from('#legal', .3, {
            autoAlpha: 0
          }, "appear-=.7") // .staggerTo(['#txt-2,#txt-3,#txt-4'], 1.5, {x:-300, ease: "expo.inOut"}, .05,'+=1.7')
          .to('#legal,#wipe-2,#txt-2,#txt-3,#txt-4', .2, {
            autoAlpha: 0
          }, '+=2.3').staggerFrom(['#txt-5', '#txt-6'], 1.5, {
            x: 300,
            ease: "expo.inOut"
          }, .05, '-=.8').from('#pack-1', .7, {
            y: -100,
            autoAlpha: 0
          }, '-=1').to(['#pack-1,#txt-5,#txt-6'], .3, {
            autoAlpha: 0
          }, '+=2.3').to('#logo', .1, {
            y: -45
          }, '-=1').to('#logo', 2, {
